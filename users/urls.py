...
from .views import IndexView, UserCreateView, LoginView, ConfirmCodeView, AuthorListView, AuthorCreateView, ProfileView, \
    ProfileUpdateView, AuthorDetailView, UserSetPasswordView, AuthorProfileView, AuthorProfileUpdateView
...
urlpatterns = [
    ...
    path('author-profile/update/', AuthorProfileUpdateView.as_view(), name='profile_author_update'),
